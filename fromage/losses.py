...
def contrastive_loss_neg(logits: torch.Tensor, labels) -> torch.Tensor:
  return torch.nn.functional.cross_entropy(logits, labels)

def contrastive_acc_neg(logits: torch.Tensor, target: Optional[torch.Tensor] = None, topk=(1,)) -> torch.Tensor:
  """
  Args:
